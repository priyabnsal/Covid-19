...
// body view
const visualize = ([
  { total_cases, total_deaths, total_recovered, new_cases, new_deaths },
  { countries_stat },
]) => {
  render(
    document.body,
    html`
      <div id="content">
        <nav
          class="navbar navbar-expand navbar-light text-center bg-white topbar mb-4 static-top shadow"
        >
          <div class="col-md-12">
        ...
        <footer class="sticky-footer bg-light shadow">
          <div class="container my-auto text-center">
            ...
            <div class="social-btns">
              <a class="btn facebook" href="https://www.facebook.com/akzonstore"
                ><i class="fa fa-facebook"></i></a
              ><a class="btn twitter" href="https://twitter.com/mrakcreation"
                ><i class="fa fa-twitter"></i></a
              ><a
                class="btn instagram"
                href="https://www.instagram.com/iamishu_sharma/"
                ><i class="fa fa-instagram"></i></a
              ><a class="btn skype" href="skype:live:77476bf129c63267?chat"
                ><i class="fa fa-skype"></i></a
              ><a
                class="btn youtube"
                href="https://www.youtube.com/MrAKCreation"
            ...
            <div class="copyright text-center my-auto">
              <span class="font-weight-bold"
                >Copyright &copy; COVID-19 Tracker
...
// updater
const update = () => Promise.all(grabData()).then(visualize, console.error);
